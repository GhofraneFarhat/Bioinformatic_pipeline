...
def get_conversion_class(tool_name, tool_version):
    ...
    conversion_classes = {
        ('classify', '1.0.0'): ('tool_conversion.classify_conversion', 'FastaToCsv'),
        ('plASgraph', '1.0.0'): ('tool_conversion.plasgraph_conversion', 'CsvToCsv'),
        ('plASgraph2', '2.0.0'): ('tool_conversion.plasgraph2_conversion', 'Plasgraph2ToCsv'),
        ('bin_tool', '1.0.0'): ('tool_conversion.plasgraph_conversion', 'CsvToCsv'),
        ('plasbin_flow', '1.0.0'): ('tool_conversion.plasbin_flow_conversion', 'TsvToCsv'),
    }
